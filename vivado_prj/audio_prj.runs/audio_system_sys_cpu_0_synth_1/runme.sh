...
HD_PWD='C:/master/new/vivado_prj/audio_prj.runs/audio_system_sys_cpu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_system_sys_cpu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_system_sys_cpu_0.tcl
