...
#
# Script generated by Vivado on Thu Jun 18 14:48:04 +0200 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : audio_system.sh
...
#
# Usage        : audio_system.sh
#                audio_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                audio_system.sh [-reset_run]
#                audio_system.sh [-reset_log]
#                audio_system.sh [-help]
#
...
#                script (type 'audio_system.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xil_defaultlib -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname generic_baseblocks_v2_1_2 -libname axi_register_slice_v2_1_31 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_crossbar_v2_1_32 -libname lib_pkg_v1_0_4 -libname axi_lite_ipif_v3_0_4 -libname interrupt_control_v3_1_5 -libname axi_iic_v2_1_7 -libname axi_protocol_converter_v2_1_31 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xil_defaultlib lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 generic_baseblocks_v2_1_2 axi_register_slice_v2_1_31 fifo_generator_v13_2_10 axi_data_fifo_v2_1_30 axi_crossbar_v2_1_32 lib_pkg_v1_0_4 axi_lite_ipif_v3_0_4 interrupt_control_v3_1_5 axi_iic_v2_1_7 axi_protocol_converter_v2_1_31)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "audio_system.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./audio_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_32 $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_31 $xmvlog_opts +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/ec67/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/b28c/hdl" +incdir+"../../../../audio_prj.gen/sources_1/bd/audio_system/ipshared/3242" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.audio_system xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.audio_system -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log audio_system_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./audio_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: audio_system.sh [-help]\n\
Usage: audio_system.sh [-step]\n\
Usage: audio_system.sh [-lib_map_path]\n\
Usage: audio_system.sh [-reset_run]\n\
Usage: audio_system.sh [-reset_log]\n\
Usage: audio_system.sh [-keep_index]\n\
Usage: audio_system.sh [-noclean_files]\n\n\
